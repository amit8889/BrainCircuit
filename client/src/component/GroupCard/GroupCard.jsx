...
const GroupCard = () => {
  ...
  return (
    <div
      ref={ref}
      className={`transition-transform duration-1000 ease-in-out transform ${inView ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}
    >
      <div 
        className="rounded-lg bg-white shadow-xl border border-gray-200 p-6 m-4 relative overflow-hidden transition-transform duration-500 ease-in-out transform hover:scale-105 hover:shadow-1"
      >
        {/* Green Ping Animation */}
        <div
          className={`absolute top-1 right-1 w-6 h-6 rounded-full ${inView ? 'animate-ping opacity-70' : 'opacity-0'}`}
          style={{
        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          />
          <div>
            <h3 className="text-1xl font-semibold text-gray-900 tracking-tight">JavaScript</h3>
        ...
        <div className="mb-4">
          <p className="text-gray-700 text-md leading-relaxed">
            Join the discussion and share your knowledge on JavaScript. Connect with other enthusiasts and learn together!
          </p>
        </div>
